...
public class CommandLineTest {
    ...
    public void testMinimalApplication() {
        String[] args = new String[]{APK_PATH, EXAMPLE_APK_PATH, PLATFORM_PATH, EXAMPLE_PLATFORM_PATH, RULES_DIR, EXAMPLE_RULES_DIR};
    ...
    public void testMissingApkPath() {
        String[] args = new String[]{PLATFORM_PATH, EXAMPLE_PLATFORM_PATH, RULES_DIR, EXAMPLE_RULES_DIR};
        HeadlessAndroidScanner scanner = HeadlessAndroidScanner.createFromCLISettings(args);
    ...
    public void testMissingRulesDir() {
        String[] args = new String[]{APK_PATH, EXAMPLE_APK_PATH, PLATFORM_PATH, EXAMPLE_PLATFORM_PATH};
        HeadlessAndroidScanner scanner = HeadlessAndroidScanner.createFromCLISettings(args);
    ...
    public void testReportPath() {
        ...
        String[] args = new String[]{APK_PATH, EXAMPLE_APK_PATH, PLATFORM_PATH, EXAMPLE_PLATFORM_PATH, RULES_DIR, EXAMPLE_RULES_DIR, REPORT_PATH, reportPath};
        HeadlessAndroidScanner scanner = HeadlessAndroidScanner.createFromCLISettings(args);
    ...
    public void testReportFormat() {
        String[] cmdArgs = new String[]{APK_PATH, EXAMPLE_APK_PATH, PLATFORM_PATH, EXAMPLE_PLATFORM_PATH, RULES_DIR, EXAMPLE_RULES_DIR, REPORT_FORMAT, "CMD"};
        ...
        String[] txtArgs = new String[]{APK_PATH, EXAMPLE_APK_PATH, PLATFORM_PATH, EXAMPLE_PLATFORM_PATH, RULES_DIR, EXAMPLE_RULES_DIR, REPORT_FORMAT, "TXT"};
        ...
        String[] sarifArgs = new String[]{APK_PATH, EXAMPLE_APK_PATH, PLATFORM_PATH, EXAMPLE_PLATFORM_PATH, RULES_DIR, EXAMPLE_RULES_DIR, REPORT_FORMAT, "SARIF"};
        HeadlessAndroidScanner sarifScanner = HeadlessAndroidScanner.createFromCLISettings(sarifArgs);
        Assert.assertEquals(sarifScanner.getReportFormats(), Set.of(Reporter.ReportFormat.SARIF));

        String[] csvArgs = new String[]{APK_PATH, EXAMPLE_APK_PATH, PLATFORM_PATH, EXAMPLE_PLATFORM_PATH, RULES_DIR, EXAMPLE_RULES_DIR, REPORT_FORMAT, "CSV"};
        ...
        String[] csvSummaryArgs = new String[]{APK_PATH, EXAMPLE_APK_PATH, PLATFORM_PATH, EXAMPLE_PLATFORM_PATH, RULES_DIR, EXAMPLE_RULES_DIR, REPORT_FORMAT, "CSV_SUMMARY"};
        HeadlessAndroidScanner csvSummaryScanner = HeadlessAndroidScanner.createFromCLISettings(csvSummaryArgs);
        Assert.assertEquals(csvSummaryScanner.getReportFormats(), Set.of(Reporter.ReportFormat.CSV_SUMMARY));

        String[] annotationArgs = new String[]{APK_PATH, EXAMPLE_APK_PATH, PLATFORM_PATH, EXAMPLE_PLATFORM_PATH, RULES_DIR, EXAMPLE_RULES_DIR, REPORT_FORMAT, "GITHUB_ANNOTATION"};
        HeadlessAndroidScanner annotationScanner = HeadlessAndroidScanner.createFromCLISettings(annotationArgs);
        Assert.assertEquals(annotationScanner.getReportFormats(), Set.of(Reporter.ReportFormat.GITHUB_ANNOTATION));

        String[] multipleArgs = new String[]{APK_PATH, EXAMPLE_APK_PATH, PLATFORM_PATH, EXAMPLE_PLATFORM_PATH, RULES_DIR, EXAMPLE_RULES_DIR, REPORT_FORMAT, "CMD,TXT,CSV"};
        HeadlessAndroidScanner multipleFormatsScanner = HeadlessAndroidScanner.createFromCLISettings(multipleArgs);
