...
/**
 * Running the tests requires an Android platform. Since they are licensed and quite large, they should not be
 * uploaded to the GitHub remote. If you plan to run the tests, copy a platform (e.g. 'android-35') into the
...
public abstract class AbstractAndroidTest {
    ...
    protected static final String JCA_RULES_DIR = "." + File.separator + "src" + File.separator + "test" + File.separator + "resources" + File.separator + "JavaCryptographicArchitecture" + File.separator;
