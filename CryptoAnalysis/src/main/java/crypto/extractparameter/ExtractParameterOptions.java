    ...
    public Optional<AllocVal> getAllocationVal(Method m, Statement stmt, Val fact) {
        if (stmt.isAssign()) {
            ...
            if (stmt.containsInvokeExpr()) {
                ...
                Optional<AllocVal> extractedStringValue =
                        stringTransformation.evaluateExpression(stmt);
                ...
                Optional<AllocVal> extractedWrapperValue =
                        wrapperTransformation.evaluateExpression(stmt);
                ...
                OperatorTransformation operatorTransformation =
                        new OperatorTransformation(definition);
                Optional<AllocVal> extractedOperatorValue =
                        operatorTransformation.evaluateExpression(stmt);
