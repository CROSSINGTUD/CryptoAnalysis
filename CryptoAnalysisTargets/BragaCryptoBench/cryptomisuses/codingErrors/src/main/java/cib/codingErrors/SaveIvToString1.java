...
public final class SaveIvToString1 {
  ...
  public static void main(String args[]) throws NoSuchAlgorithmException,
    ...
    String iv2s = new String(iv, StandardCharsets.US_ASCII);
    
    dec.init(Cipher.DECRYPT_MODE, k, new IvParameterSpec(iv2s.getBytes("UTF-8")));
