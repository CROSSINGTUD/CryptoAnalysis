...
public class MUBenchExamplesTest extends AbstractHeadlessTest {
    ...
    public void muBenchExamples() {
        ...
        addErrorSpecification(new ErrorSpecification.Builder("example.CipherUsesBlowfishExample", "main", 1)
        ...
        addErrorSpecification(new ErrorSpecification.Builder("example.CipherUsesBlowfishWithECBModeExample", "main", 1)
                .withTPs(ConstraintError.class, 1)
                .withTPs(IncompleteOperationError.class, 1)
                .build());
        ...
        addErrorSpecification(new ErrorSpecification.Builder("example.CipherUsesDESExample", "main", 1)
                .withTPs(ConstraintError.class, 1)
                .withTPs(IncompleteOperationError.class, 1)
                .build());
        ...
        addErrorSpecification(new ErrorSpecification.Builder("example.CipherUsesDSAExample", "main", 1)
                .withTPs(ConstraintError.class, 1)
                .withTPs(IncompleteOperationError.class, 1)
                .build());
        ...
        addErrorSpecification(new ErrorSpecification.Builder("example.CipherUsesJustAESExample", "main", 1)
                .withTPs(ConstraintError.class, 1)
                .withTPs(IncompleteOperationError.class, 1)
                .build());
        ...
        addErrorSpecification(new ErrorSpecification.Builder("example.CipherUsesNonRandomKeyExample", "main", 1)
        ...
        addErrorSpecification(new ErrorSpecification.Builder("example.CipherUsesPBEWithMD5AndDESExample", "main", 1)
                .withTPs(ConstraintError.class, 1)
                .withTPs(IncompleteOperationError.class, 1)
                .build());
        ...
        addErrorSpecification(new ErrorSpecification.Builder("example.CipherUsesRSAWithCBCExample", "main", 1)
                .withTPs(ConstraintError.class, 1)
                .withTPs(IncompleteOperationError.class, 1)
                .build());
        ...
        addErrorSpecification(new ErrorSpecification.Builder("example.EmptyArrayUsedForCipherDoFinalExample", "main", 1)
                .withTPs(ConstraintError.class, 1)
                .build());

        // This test case corresponds to the following project in MUBench having this misuse:
        // https://github.com/akwick/MUBench/blob/master/data/red5-server/misuses/1/misuse.yml
        addErrorSpecification(new ErrorSpecification.Builder("example.InitInMacCalledMoreThanOnceExample", "main", 1)
