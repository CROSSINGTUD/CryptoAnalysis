...
/**
 * The following Headless tests are deducted from the CryptoGuard benchmarking tool that detects
 * various Cryptographic API misuses. For the creating these Headless tests, various projects from
 * CryptoGuard were considered and can be found in the following link:
 *
 * @author Enri Ozuni
 * @see <a
 *     href="https://github.com/CryptoGuardOSS/cryptoapi-bench">https://github.com/CryptoGuardOSS/cryptoapi-bench</a>
 */
public class CryptoGuardTest extends AbstractHeadlessTest {
    ...
    public void brokenCryptoExamples() {
        String mavenProjectPath =
                new File("../CryptoAnalysisTargets/CryptoGuardExamples/brokencrypto")
                        .getAbsolutePath();
        ...
        addErrorSpecification(
                new ErrorSpecification.Builder(
                                "example.brokencrypto.BrokenCryptoABICase1", "doCrypto", 1)
    ...
    public void brokenHashExamples() {
        String mavenProjectPath =
                new File("../CryptoAnalysisTargets/CryptoGuardExamples/brokenhash")
                        .getAbsolutePath();
        MavenProject mavenProject = createAndCompile(mavenProjectPath);
        HeadlessJavaScanner scanner = createScanner(mavenProject);
        ...
        addErrorSpecification(
                new ErrorSpecification.Builder("example.brokenhash.BrokenHashABICase1", "go", 2)
                        .withTPs(ConstraintError.class, 1)
                        .build());
        ...
        addErrorSpecification(
                new ErrorSpecification.Builder("example.brokenhash.BrokenHashABICase5", "go", 1)
                        .withTPs(ImpreciseValueExtractionError.class, 1)
                        .build());
        ...
        addErrorSpecification(
                new ErrorSpecification.Builder("example.brokenhash.BrokenHashBBCase2", "main", 1)
                        .withTPs(ConstraintError.class, 1)
                        .build());
    ...
    public void ecbCryptoExamples() {
        String mavenProjectPath =
                new File("../CryptoAnalysisTargets/CryptoGuardExamples/ecbcrypto")
                        .getAbsolutePath();
        MavenProject mavenProject = createAndCompile(mavenProjectPath);
        HeadlessJavaScanner scanner = createScanner(mavenProject);
        ...
        addErrorSpecification(
                new ErrorSpecification.Builder("example.ecbcrypto.EcbInSymmCryptoABICase1", "go", 1)
                        .withTPs(ConstraintError.class, 1)
                        .withTPs(IncompleteOperationError.class, 1)
                        .build());
        ...
        addErrorSpecification(
                new ErrorSpecification.Builder("example.ecbcrypto.EcbInSymmCryptoBBCase1", "go", 0)
                        .withTPs(ConstraintError.class, 1)
                        .withTPs(IncompleteOperationError.class, 1)
                        .build());
        ...
        addErrorSpecification(
                new ErrorSpecification.Builder(
                                "example.ecbcrypto.EcbInSymmCryptoCorrected", "go", 0)
                        .withTPs(ConstraintError.class, 1)
                        .withTPs(IncompleteOperationError.class, 1)
                        .build());
    ...
    public void insecureAsymmetricCryptoExamples() {
        String mavenProjectPath =
                new File("../CryptoAnalysisTargets/CryptoGuardExamples/insecureasymmetriccrypto")
                        .getAbsolutePath();
        MavenProject mavenProject = createAndCompile(mavenProjectPath);
        HeadlessJavaScanner scanner = createScanner(mavenProject);
        ...
        addErrorSpecification(
                new ErrorSpecification.Builder(
                                "example.insecureasymmetriccrypto.InsecureAsymmetricCipherABICase1",
                                "main",
                                1)
        ...
        addErrorSpecification(
                new ErrorSpecification.Builder(
                                "example.insecureasymmetriccrypto.InsecureAsymmetricCipherBBCase1",
                                "go",
                                0)
                        .withTPs(ConstraintError.class, 1)
                        .withTPs(IncompleteOperationError.class, 2)
    ...
    public void pbeIterationExamples() {
        String mavenProjectPath =
                new File("../CryptoAnalysisTargets/CryptoGuardExamples/pbeiteration")
                        .getAbsolutePath();
        MavenProject mavenProject = createAndCompile(mavenProjectPath);
        HeadlessJavaScanner scanner = createScanner(mavenProject);
        ...
        addErrorSpecification(
                new ErrorSpecification.Builder(
                                "example.pbeiteration.LessThan1000IterationPBEABICase1", "key2", 1)
                        .withTPs(ConstraintError.class, 1)
                        .build());
        ...
        addErrorSpecification(
                new ErrorSpecification.Builder(
                                "example.pbeiteration.LessThan1000IterationPBEBBCase1", "key2", 0)
                        .withTPs(ConstraintError.class, 1)
                        .build());
        ...
        addErrorSpecification(
                new ErrorSpecification.Builder(
                                "example.pbeiteration.LessThan1000IterationPBEABHCase1", "key2", 0)
                        .withTPs(ImpreciseValueExtractionError.class, 1)
                        .build());
        ...
        addErrorSpecification(
                new ErrorSpecification.Builder(
                                "example.pbeiteration.LessThan1000IterationPBEABICase2", "key2", 0)
                        .withTPs(ImpreciseValueExtractionError.class, 1)
                        .build());
    ...
    public void predictableCryptographicKeyExamples() {
        String mavenProjectPath =
                new File("../CryptoAnalysisTargets/CryptoGuardExamples/predictablecryptographickey")
                        .getAbsolutePath();
        MavenProject mavenProject = createAndCompile(mavenProjectPath);
        HeadlessJavaScanner scanner = createScanner(mavenProject);
        ...
        addErrorSpecification(
                new ErrorSpecification.Builder(
                                "example.predictablecryptographickey.PredictableCryptographicKeyABHCase1",
                                "main",
                                1)
                        .withTPs(RequiredPredicateError.class, 1)
                        .build());
        ...
        addErrorSpecification(
                new ErrorSpecification.Builder(
                                "example.predictablecryptographickey.PredictableCryptographicKeyABICase1",
                                "go",
                                1)
                        .withTPs(RequiredPredicateError.class, 1)
                        .build());
        ...
        addErrorSpecification(
                new ErrorSpecification.Builder(
                                "example.predictablecryptographickey.PredictableCryptographicKeyBBCase1",
                                "main",
                                1)
                        .withTPs(RequiredPredicateError.class, 1)
                        .build());
        ...
        addErrorSpecification(
                new ErrorSpecification.Builder(
                                "example.predictablecryptographickey.PredictableCryptographicKeyABHCase2",
                                "main",
                                1)
                        .withTPs(RequiredPredicateError.class, 1)
                        .build());
        ...
        addErrorSpecification(
                new ErrorSpecification.Builder(
                                "example.predictablecryptographickey.PredictableCryptographicKeyABICase2",
                                "go",
                                0)
                        .withTPs(RequiredPredicateError.class, 1)
                        .build());
    ...
    public void predictableKeyStorePasswordExamples() {
        String mavenProjectPath =
                new File("../CryptoAnalysisTargets/CryptoGuardExamples/predictablekeystorepassword")
                        .getAbsolutePath();
        MavenProject mavenProject = createAndCompile(mavenProjectPath);
        HeadlessJavaScanner scanner = createScanner(mavenProject);
    ...
    public void predictablePBEPasswordExamples() {
        String mavenProjectPath =
                new File("../CryptoAnalysisTargets/CryptoGuardExamples/predictablepbepassword")
                        .getAbsolutePath();
        MavenProject mavenProject = createAndCompile(mavenProjectPath);
        HeadlessJavaScanner scanner = createScanner(mavenProject);
    ...
    public void staticInitializationVectorExamples() {
        String mavenProjectPath =
                new File("../CryptoAnalysisTargets/CryptoGuardExamples/staticinitializationvector")
                        .getAbsolutePath();
        MavenProject mavenProject = createAndCompile(mavenProjectPath);
        HeadlessJavaScanner scanner = createScanner(mavenProject);
        ...
        addErrorSpecification(
                new ErrorSpecification.Builder(
                                "example.staticinitializationvector.StaticInitializationVectorABHCase1",
                                "go",
                                0)
                        .withTPs(ConstraintError.class, 1)
                        .withTPs(RequiredPredicateError.class, 1)
        ...
        addErrorSpecification(
                new ErrorSpecification.Builder(
                                "example.staticinitializationvector.StaticInitializationVectorABHCase2",
                                "go",
                                0)
                        .withTPs(ConstraintError.class, 1)
                        .withTPs(RequiredPredicateError.class, 1)
        ...
        addErrorSpecification(
                new ErrorSpecification.Builder(
                                "example.staticinitializationvector.StaticInitializationVectorABICase1",
                                "go",
                                1)
                        .withTPs(ConstraintError.class, 1)
                        .withTPs(IncompleteOperationError.class, 1)
        ...
        addErrorSpecification(
                new ErrorSpecification.Builder(
                                "example.staticinitializationvector.StaticInitializationVectorABICase2",
                                "go",
                                1)
                        .withTPs(ConstraintError.class, 1)
                        .withTPs(IncompleteOperationError.class, 1)
        ...
        addErrorSpecification(
                new ErrorSpecification.Builder(
                                "example.staticinitializationvector.StaticInitializationVectorBBCase1",
                                "go",
                                0)
                        .withTPs(ConstraintError.class, 1)
                        .withTPs(RequiredPredicateError.class, 1)
    ...
    public void staticSaltsExamples() {
        String mavenProjectPath =
                new File("../CryptoAnalysisTargets/CryptoGuardExamples/staticsalts")
                        .getAbsolutePath();
        MavenProject mavenProject = createAndCompile(mavenProjectPath);
        HeadlessJavaScanner scanner = createScanner(mavenProject);
        ...
        addErrorSpecification(
                new ErrorSpecification.Builder("example.staticsalts.StaticSaltsABHCase1", "key2", 0)
                        .withTPs(ConstraintError.class, 1)
                        .withTPs(RequiredPredicateError.class, 1)
                        .build());
        ...
        addErrorSpecification(
                new ErrorSpecification.Builder("example.staticsalts.StaticSaltsABICase2", "key2", 1)
                        .withTPs(ConstraintError.class, 1)
                        .withTPs(RequiredPredicateError.class, 1)
                        .build());
        ...
        addErrorSpecification(
                new ErrorSpecification.Builder("example.staticsalts.StaticSaltsBBCase1", "key2", 0)
                        .withTPs(ConstraintError.class, 1)
                        .withTPs(RequiredPredicateError.class, 1)
                        .build());
