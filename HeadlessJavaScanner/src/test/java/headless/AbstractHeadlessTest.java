...
import headless.FindingsType.NoFalsePositives;
...
public abstract class AbstractHeadlessTest {
	...
	protected static final String RULES_BASE_DIR = "." + File.separator + "src" + File.separator + "main" + File.separator + "resources" + File.separator;
